...
export const experienceList = [
  {
    ...
    highlights: [
      ...
      "Designed 9+ Power BI dashboards using Microsoft Fabric semantic models (DAX, Power Query/M), supporting budget tracking across 4 strategic projects and earning placement among Viatris' top 3% highest-utilized dashboards",
      "Building a PySpark-based data warehouse on Microsoft Fabric with Azure Data Factory orchestration and Delta Lake medallion architecture, processing 10M+ records for enterprise Power BI semantic models",
    ],
  },
  {
    organization: "Viatris Inc.",
    ...
    location: "USA",
    highlights: [
      "Translated complex business requirements from Senior Directors and VPs into technical specifications, delivering automated analytics adopted across 4 global teams and accelerating executive decision-making",
      "Enhanced reporting capabilities, designed and optimized 100+ SQL queries and created Power BI dashboards for Senior Directors and Lead Specialists",
      "Built ETL pipelines and optimized 50+ Alteryx workflows automating forecast-versus-actual variance analysis, reducing reporting cycle time by 28% and improving planning accuracy across business units",
      "Delivered a Power Apps solution integrating SharePoint, Dataverse, Power Automate, and Microsoft Copilot Studio, streamlining operational data collection for 5 Lead Specialists and eliminating duplicate submissions",
      "Streamlined reporting with Power Automate workflows on SharePoint lists, automating version-controlled reporting, notifications, and summaries while saving 12+ analyst hours weekly",
