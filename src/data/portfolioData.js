...
export const experienceList = [
  {
    ...
    highlights: [
      ...
      "Designed 5+ Power BI dashboards on semantic models in Microsoft Fabric (DAX, Power Query/M) for budget tracking and risk escalation across 4 projects that ranked in the top 3% of dashboards at Viatris",
  ...
  },
  {
    ...
    location: "USA",
    highlights: [
      "Translated complex business requirements from Senior Directors leadership into detailed technical specifications, configuring automated pipelines, metrics, and executive visuals, accelerating systemwide adoption across 4+ global teams",
      "Enhanced reporting capabilities, designed and optimized 100+ SQL style queries, and created Power BI dashboards for Senior Directors and Lead Specialists",
      ...
      "Delivered a solution using Power Apps, SharePoint, and Dataverse integrating multiple reports using Power Automate to capture and submit operational data, integrated with Microsoft Copilot Studio agent, adopted by 2 teams",
