...
import heroVideo from '../assets/siddhant/hero-talking-video.mp4';
import heroPoster from '../assets/siddhant/hero-image.png';
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.tableau} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#ff2a2a] font-black" aria-label="Tableau Public">
              T
            </a>
          </div>
        ...
        <div 
          ...
          onClick={toggleVideo}
          onKeyDown={(e) => {
            if (e.key === 'Enter' || e.key === ' ') toggleVideo(e);
          }}
          role="button"
          tabIndex="0"
