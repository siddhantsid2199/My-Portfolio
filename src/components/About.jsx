...
const StackMark = ({ short, label, color }) => (
  <div className="flex flex-col items-center gap-2">
    <div
      className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-black/90 border border-white/20 flex items-center justify-center text-white text-xl md:text-2xl font-black shadow-2xl"
      style={{ boxShadow: `0 15px 35px ${color}` }}
    >
      {short}
    </div>
    <span className="text-[10px] md:text-xs font-bold text-white/80 uppercase tracking-wider text-center">
      {label}
    </span>
  </div>
);
  ...
  <section id="about" className="bg-[#ff2a2a] pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
      ...
      <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
        ...
        />
        <div className="flex flex-wrap items-start gap-8 md:gap-10 mt-8">
          <div data-aos="zoom-in" data-aos-delay="300" className="hover:scale-110 transition-transform duration-300">
