    ...
    <div className={`rounded-2xl p-5 md:p-6 h-full backdrop-blur-md transition-all duration-500 flex flex-col ${
      ...
      <div className="flex flex-wrap gap-2 mb-5">
        {project.outcomes.map((outcome) => (
          <span key={outcome} className="px-3 py-1.5 text-xs font-black text-red-300 bg-red-500/10 rounded-full border border-red-500/20">
            {outcome}
          </span>
        ))}
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg font-medium leading-relaxed">
            Analytics products that translate complex operational data into clear, actionable decisions.
          </p>
        </div>
